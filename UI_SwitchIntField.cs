...
public class UI_SwitchIntField : MonoBehaviour { 


    [SerializeField] private UI_SwitchButtonsController uI_SwitchButtonsController;
    ...
    private void Start()
    {
        ...
        uI_SwitchButtonsController.SetTotalNumber(Finalnumber);
